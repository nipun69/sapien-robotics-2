...
```text
├── dataset/                # Place your raw downloaded dataset here
│   └── PCB_DATASET/        # (Must contain 'Annotations' and 'images' folders)
├── dataset_fixed/          # Auto-generated by Script 01 (YOLO formatted)
├── runs/                   # Stores training results and weights
├── 01_fix_dataset_structure.py   # Data preprocessing script
├── 02_train_model.py             # Model training script
├── 03_inspection_system.py       # Inference and reporting script
